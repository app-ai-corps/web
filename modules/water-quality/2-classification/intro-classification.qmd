...
For example, see the project from the University of Georgia, Athens [^2] below that uses multiclass classification to sort lemons, discarding those that are underripe and molded and retaining only those that are ripe.
