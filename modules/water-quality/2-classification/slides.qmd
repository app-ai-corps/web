...
- Example: At University of Maryland, AI is used to identify ripe crops in fields [^1]

![](images/ripe_strawberry_detection_umd_strawberriesonly.png){fig-align="center" height="450"}
...
<center>
<!-- <video width="80%" controls>
  <source src="images/buoy-classification.mp4" type="video/mp4">
  Your browser does not support the video tag.
</video> -->

<iframe src="https://drive.google.com/file/d/1OIjSpeVHHgxG2_YDswYqrS_4BC2tCaVy/preview" width="80%" height="80%"></iframe>
</center>
```
# Neural Networks
