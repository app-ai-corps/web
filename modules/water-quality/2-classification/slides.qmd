...
[^1]: Project from University of Georgia, Athens
...
<hr>
**How does the buoy use classification?**
...
:::{.fragment}
With your group, think about the jobs of the input layer, hidden layers, and output layer in a CNN that works to classify cows. 🐮
<br><br>
...
<br>
<center>
[🎉 Great job! You've learned so much!<br>Share what you've learned on the [**Exit Ticket**](https://forms.gle/23LAwb5GcBWAhd1K8).]{.thirtyfourpt-font}
</center>
...
<br>
<center>
[Want to practice what we've learned?<br>Try the **Exercises**<br>(Ask Your Teacher For the Link).]{.thirtyfourpt-font}
</center>