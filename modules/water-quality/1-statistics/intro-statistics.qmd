...
#### Mean
The *mean* ($\bar{x}$) is often called the "average". To find the mean, we add up all of the numbers of interest and divide by how many numbers there are.
...
:::
The sum of all x (all the values), divided by how many there are (n).
...
**To-do:** Using your calculator, calculate the mean estimates nitrate concentration and the mean nitrite concentration for your samples.

**To-do:**Then, calculate the median nitrate concentration and nitrite concentration for your samples.
