...
## Workshop Structure
<hr>
There are multiple pages in each module:
![](images/module-page-navigation.png)

## Workshop Structure
<hr>
The pages contain **checkpoints**. The checkpoints are linked at the top of the page and include code blocks to run and questions to answer.
<br>
