...
# Think about the water you drink. Where is it from?
...
- [**Checkpoint 1:** Print Statements](javascript:void(0))
- [**Checkpoint 2:** Mathematical Operators](javascript:void(0))
- [**Checkpoint 3:** Comparing Values](javascript:void(0))
- [**Checkpoint 4:** Print Statements with Math](javascript:void(0))
- [**Checkpoint 5:** Your Own Print Statements](javascript:void(0))
...
:::{.ltblue-container .twentyfourpt-font}
🎯 **Checkpoint 2**: Basic functions with lists.
:::
...
:::{.ltblue-container .twentyfourpt-font}
🎯 **Checkpoint 3**: Calculate the mean of the class nitrate and nitrite data.
:::
...
<br>
<center>
[🎉 Great job! You've learned so much!<br>Share what you've learned on the [**Exit Ticket**](exit-ticket).]{.thirtyfourpt-font}
</center>
...
<br>
<center>
[Want to practice what we've learned?<br>Try the [**Exercises**](exercises).]{.thirtyfourpt-font}
</center>