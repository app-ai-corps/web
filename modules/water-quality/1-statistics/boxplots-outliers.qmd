...
1. After your groups has received all of its stickies, create two stacks—one for nitrate and one for nitrite (you can distinguish them by the writing color). 
...
![](images/boxplots_medianline.png)
...
![](images/ordered_nitrate_nitrite_stickies_q1.png)

![](images/ordered_nitrate_nitrite_stickies_q3.png)

6. Draw the line for the first and third quartiles for both the nitrates and nitrites data.

![](images/boxplots_quartiles.png)
