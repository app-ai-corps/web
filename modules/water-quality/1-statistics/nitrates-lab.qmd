...
- pencils  
- 8 sets of multicolor sticky notes (you will have 1 color sticky note for each small group)  
- 2 Sharpie markers of different colors (1 color for nitrates and 1 color for nitrites) 
...
- **Role 3:** Data Recorder (Sticky Notes)  
    - *Needs:*  
        - sets of small sticky notes (at least eight sets, two sets per water sample)
        - Sharpies
...
:::{.callout-note}
## Modifications for Different Team Sizes
- If your team has ***three members***, one person should be the *Data Recorder (Lab Report)* and the *Data Recorder (Computer)*.
- If your team has ***five members***, split the *Data Recorder (Sticky Notes)* between two people. One person should fill out the sticky notes for nitrate concentrations with the first Sharpie, and the other person should fill out the sticky notes for nitrite concentrations with the second Sharpie.
:::
...
4. **Data Recorder (Sticky Notes):**  
    - Using the nitrate-color Sharpie, write the nitrate concentration for the sample on a set of sticky notes. Put the set to the side.  
    - Using the nitrite-color Sharpie, write the nitrite concentration for the sample on a second set of sticky notes. Put the set to the side.
