...
- [**Checkpoint 2:** Basic Functions with Lists](#lst-basicfunctions)
- [**Checkpoint 3:** Making Comparisons](#lst-comparisons)
:::
...
Explore Basic Operations with Lists!
:::
...
:::{#lst-making-comparisons}

Let's use Python to check if water is safe. We can tell Python the maximum EPA-allowed concentration of nitrate and have it compare the maximum nitrate reading with that cut-off. Change `??` in the block below to the EPA limit for nitrate.
```{pyodide}
...
Comparing nitrate readings to EPA limits!
:::
