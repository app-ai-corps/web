...
```{python}
# Our sample dataset from above (the square brackets [ ] make it a list)
...
**Breaking it down:**  
- `sample_data` = the name we gave our list (you can name it anything!)  
